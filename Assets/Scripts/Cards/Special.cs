...
public static Special putridSpell3 = new Special(SpecialCategory.Putrid, SpecialUsage.Spell, "putrid spell 3", "ALL monsters have -2X resist for 2 turns.", 5);
...
public static Special revenantSpell3 = new Special(SpecialCategory.Revenant, SpecialUsage.Spell, "revenant spell 3", "Restore 10 HP to all friendly monsters.", 4);
...
public static Special arcaneSpell2 = new Special(SpecialCategory.Arcane, SpecialUsage.Spell, "arcane spell 2", "Deal 10X damage to front enemy monster.", 6);
...
public static Special cursedSpell1 = new Special(SpecialCategory.Cursed, SpecialUsage.Spell, "cursed spell 1", "Your midline autoattacks apply Curse for 2 turns.", 5);
public static Special cursedSpell2 = new Special(SpecialCategory.Cursed, SpecialUsage.Spell, "cursed spell 2", "Curse target position. Monsters standing there take 5X damage from your next attack.", 3);
...
public static Special shifterPassive2 = new Special(SpecialCategory.Shifter, SpecialUsage.Passive, "shifter passive 2", "Autoattacks drain 2X mana from your opponent.", 0);
...
public static Special revenantPassive3 = new Special(SpecialCategory.Revenant, SpecialUsage.Passive, "revenant passive 3", "Each time this monster swaps positions, heal the monster it is swapped with 5X HP and Cleanse it.", 0);
...
public static Special cursedPassive1 = new Special(SpecialCategory.Cursed, SpecialUsage.Passive, "cursed passive 1", "Whichever monster kills this monster takes 5X damage and is permanently Silenced.", 0);
